...
def train_model(args):
    ...
    new_model.add(tf.keras.layers.Dense(units=8, activation="softmax"))

    opt=tf.keras.optimizers.Adam(learning_rate=learning_rate)
    new_model.compile(optimizer=opt,loss="categorical_crossentropy",metrics=["categorical_accuracy"])
    ...
    train_model = new_model.fit(X_train,Y_train,
                            epochs=max_epoch,
...
def main():
    ...
    parser.add_argument('--x_path', type=str, default="/data1/cs330/project/project/fine_tune_x.npy",
                        help="x")

    parser.add_argument('--y_path', type=str, default="/data1/cs330/project/project/fine_tune_y.npy",
                        help="y")
    
    parser.add_argument('--log_dir', type=str, default="/data1/cs330/project/fine_tune/model1_tune",
                        help="log")

    parser.add_argument('--fine_tune_weights', type=str, default="/data1/cs330/project/train/model1",
                        help="weight")
