...
from models.core import Model_ChoiceNet_emb, TransferModel
...
def main():
    ...
    parser.add_argument(
        "--weight_matrix_path",
        type=str,
        default="/data1/cs330/project/res_net_embedding/emb_resnet_x_all.npy",
    ...
    parser.add_argument(
        "--log_dir",
        type=str,
        default="/data1/cs330/project/test_tdl_weight_only",
        help="log",
    )
